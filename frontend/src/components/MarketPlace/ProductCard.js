			...
			<div className="px-5 py-5">
				...
				<div className="flex mt-4 md:mt-2">
					<a
						...
						className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-bold rounded-lg text-xl px-5 py-4 text-center">
						Contact Seller
						<svg
							aria-hidden="true"
