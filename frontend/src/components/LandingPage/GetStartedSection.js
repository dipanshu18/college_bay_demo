...
function GetStartedSection() {
	return (
		<section id="get-started" className="bg-white text-center py-[10vh]">
			...
			<div className="my-10">
				<Link to="/signup">
					<span className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 font-bold rounded-lg text-xl px-5 py-4 text-center">
						Count me in
						<svg
							aria-hidden="true"
